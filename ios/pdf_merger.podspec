...
Pod::Spec.new do |s|
  s.name             = 'pdf_merger'
  s.version          = '0.0.1'
  s.summary          = 'A new Flutter plugin for merging a list of PDF files. It supports both android and IOS. Before call this package make sure you allow permission and file picker see example.'
  s.description      = <<-DESC
