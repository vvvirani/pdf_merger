...
class PdfMergerPlugin : FlutterPlugin, MethodCallHandler {
    ...
    override fun onMethodCall(@NonNull call: MethodCall, @NonNull result: Result) {
        ...
        if (call.method == "getPlatformVersion") {
            ...
            val outputDirPath: String? = call.argument("outDirectory")
            val outFileNamePrefix: String? = call.argument("outFileNamePrefix")
            SplitPDF(result).split(filePath, outputDirPath, outFileNamePrefix)
        } else {
